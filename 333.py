...
# ==============================================================================
# 🚨 警告：此处的 HTML/CSS 必须绝对顶格，绝不能有前置空格！
st.markdown("""
<style>
...
div[data-testid="stTextInput"] > div > div > input { background-color: rgba(4, 9, 20, 0.9) !important; color: #00f3ff !important; font-family: 'Orbitron', monospace !important; border: 1px solid rgba(0,243,255,0.5) !important; border-radius: 6px !important; text-align: center; font-size: 16px !important; font-weight: bold !important; letter-spacing: 2px; box-shadow: inset 0 0 20px rgba(0,243,255,0.1) !important; height: 50px; }
...
div.stButton > button p, div.stButton > button span, div.stButton > button div { color: #ffffff !important; font-size: 15px !important; font-weight: 500 !important; line-height: 1.5 !important;}
...
# ==============================================================================
# 🧠 [ CORE 04 ] 题库满血版：40 道极客业务题 (要求 8 完全保留)
# ==============================================================================
questions = [
...
""", unsafe_allow_html=True)
    ...
    st.markdown("""<div style="max-width: 650px; margin: 0 auto;">""", unsafe_allow_html=True)
    ...
    # --------------------------------------------------------------------------
    # 📊 核心变量预先全量计算 (彻底解决所有 NameError 和 KeyError)
    # --------------------------------------------------------------------------
    ...
    # 🔐 资产不可篡改锁 (防 Session 刷新导致 Hash 与下拉框乱跳)
    ...
    # 🧬 [模块 II & III]：核心图谱与协同沙盘 (PC端左右双栏，手机端自动折叠上下)
    col_card_l, col_card_r = st.columns([1.2, 1], gap="large")

    with col_card_l:
        st.markdown("<div class='module-title' style='margin-top: 0;'>🧬 模块 II：核心资产图谱</div>", unsafe_allow_html=True)
