...
# 🌌 [ SECTION 1 ] 终焉引擎内核与配置
# ==============================================================================
VERSION = "50.0_IMMORTAL_OMNIVERSE"
COPYRIGHT = "无名逆流"
SYS_NAME = "职场元宇宙 | 终焉矩阵 V50"
...
# ==============================================================================
# 🗃️ [ SECTION 2 ] 全局游戏常量与奖池 (置于最顶端，绝对免疫 NameError)
# ==============================================================================
QUESTIONS = [
...
MBTI_DICT = {
    "INTJ": {"role": "矩阵架构师", "tier": "UR", "tier_color": "#ff003c", "rarity": "Top 1.2%", "base_hash": 9850, "desc": "垄断核心规则的幕后操盘手，在绝境中重写了整个财团的底层代码。", "tags": ["绝对独裁", "逻辑绞肉机", "法则支配"], "skills": ["【被动】全知视界", "【法术】底层规则解构", "【领域】绝对秩序统御"], "base_roi": 1.45, "volatility": 0.20, "market_style": "宏观架构对冲与冷酷收割", "evolution_path": ["L1 架构规划者", "L2 矩阵操盘手"], "ultimate_evolution": "【绝对算力主宰】剥夺一切节点定价权"},
    "INTP": {"role": "深网风控骇客", "tier": "SSR", "tier_color": "#ffd700", "rarity": "Top 3.1%", "base_hash": 9620, "desc": "穿透财团迷雾，在深网中寻找资本漏洞的极致黑客。", "tags": ["黑盒解构", "模型杀手", "极客暴徒"], "skills": ["【被动】多维特征抽取", "【法术】零日漏洞感染", "【秘技】量子坍缩推演"], "base_roi": 1.60, "volatility": 0.45, "market_style": "高频统计套利与嗜血量化模型", "evolution_path": ["L1 边缘骇客", "L2 深网潜行者"], "ultimate_evolution": "【全知算法先知】构建百分百无损的跨网风控引擎"},
    "ISTJ": {"role": "铁血审查官", "tier": "SR", "tier_color": "#a855f7", "rarity": "Top 11.6%", "base_hash": 8850, "desc": "废土中的程序正义者，你的评估就是生与死的分界线。", "tags": ["绝对防线", "铁血程序", "风险斩杀"], "skills": ["【被动】绝对法典加护", "【护盾】重装正义壁垒", "【反击】致命风险处决"], "base_roi": 1.15, "volatility": 0.10, "market_style": "绝对风险厌恶与固收阵地战", "evolution_path": ["L1 审查哨兵", "L2 铁血执行官"], "ultimate_evolution": "【绝对防御堡垒】废土要素流转网络最终守门人"},
    "ESTJ": {"role": "战区统帅", "tier": "SSR", "tier_color": "#ffd700", "rarity": "Top 8.7%", "base_hash": 9500, "desc": "无可争议的镇压者，擅长将高层的残忍指令拆解为绝对执行的绞肉机。", "tags": ["铁血统帅", "结果导向", "战争机器"], "skills": ["【被动】战略降维打击", "【战吼】全军狂暴冲锋", "【光环】铁腕意志压制"], "base_roi": 1.35, "volatility": 0.25, "market_style": "动量突破与重火力资产倾泻", "evolution_path": ["L1 战区指挥官", "L2 废土推进者"], "ultimate_evolution": "【战争心脏】宏观绞肉机推进的中枢"},
    "INFJ": {"role": "灵能先知", "tier": "UR", "tier_color": "#ff003c", "rarity": "Top 0.9%", "base_hash": 9200, "desc": "在冰冷代码中觉醒了人类共情，能预判未来战争走向的隐秘引路人。", "tags": ["虚空远见", "信仰狂热", "灵魂操控"], "skills": ["【被动】未来因果洞视", "【光环】跨频灵魂尖啸", "【法术】精神信仰奴役"], "base_roi": 1.55, "volatility": 0.35, "market_style": "宏观周期收割与长线价值潜伏", "evolution_path": ["L1 边缘观察者", "L2 灵能布道师"], "ultimate_evolution": "【全域先知】主导数字末日时代的底层精神共识"},
    "INFP": {"role": "游吟灵魂捕手", "tier": "SR", "tier_color": "#a855f7", "rarity": "Top 4.4%", "base_hash": 8650, "desc": "在这片被财团统治的废土上，你是唯一还记得“诗与远方”的幻灵。", "tags": ["价值感召", "组织凝胶", "异端定调"], "skills": ["【被动】无形异端塑形", "【法术】直击灵魂低语", "【光环】隐性狂暴注入"], "base_roi": 1.25, "volatility": 0.30, "market_style": "另类信仰投资与利基长尾剥削", "evolution_path": ["L1 幻象叙事者", "L2 灵魂共振官"], "ultimate_evolution": "【灵魂共振核】赋予数据昂贵信仰溢价"},
    "ENTJ": {"role": "军阀霸主", "tier": "UR", "tier_color": "#ff003c", "rarity": "Top 1.8%", "base_hash": 9900, "desc": "天生的帝国建设者，在数据丛林法则中展现极强的暴力吞并能力。", "tags": ["全图开疆", "战略暴君", "降维碾压"], "skills": ["【被动】绝对暴君破局", "【战技】全域版图吞并", "【奥义】维度降级风暴"], "base_roi": 1.70, "volatility": 0.55, "market_style": "极高杠杆并购与特殊机会强吃", "evolution_path": ["L1 开拓先锋", "L2 战区统帅"], "ultimate_evolution": "【无界帝国霸主】全国市场的唯一暴君"},
    "ENTP": {"role": "混沌诡术师", "tier": "SSR", "tier_color": "#ffd700", "rarity": "Top 3.2%", "base_hash": 9400, "desc": "旧秩序的践踏者，致力于通过跨界思维寻找资本漏洞的狂徒。", "tags": ["范式爆破", "诡辩狂人", "维度跳跃"], "skills": ["【被动】旧日秩序撕裂", "【法术】跨界降维骇入", "【光环】次元逻辑崩坏"], "base_roi": 1.65, "volatility": 0.60, "market_style": "高风险套利与颠覆性灾难做空", "evolution_path": ["L1 沙盒破坏者", "L2 跨界重组官"], "ultimate_evolution": "【秩序粉碎者】亲手书写下一个纪元"},
    "ENFJ": {"role": "黑市大主教", "tier": "SSR", "tier_color": "#ffd700", "rarity": "Top 2.5%", "base_hash": 9350, "desc": "地下黑市的无冕之王，能通过恐怖的共识构建能力将佣兵聚拢为敢死队。", "tags": ["关系毒枭", "温情洗脑", "利益操盘"], "skills": ["【被动】绝对狂热结盟", "【光环】极客温情统御", "【战技】利益杠杆操盘"], "base_roi": 1.40, "volatility": 0.25, "market_style": "庞大资产池宏观操控与网络挟持", "evolution_path": ["L1 渠道统筹", "L2 联盟主理人"], "ultimate_evolution": "【引力黑洞】垄断全国巨头的绝对心智"},
    "ENFP": {"role": "废土布道者", "tier": "SR", "tier_color": "#a855f7", "rarity": "Top 8.1%", "base_hash": 8900, "desc": "充满感染力的暴乱火种，让每一场推介都变成市场崩溃的狂欢。", "tags": ["无限创意", "跨界煽动", "高频驱动"], "skills": ["【被动】群体狂热煽动", "【法术】全域流量吞噬", "【光环】异构资源强融"], "base_roi": 1.40, "volatility": 0.40, "market_style": "高波动狂热追逐与注意力收割", "evolution_path": ["L1 宣发先锋官", "L2 流量矩阵中枢"], "ultimate_evolution": "【无界基站】把控全域要素的流量高地"},
    "ISFJ": {"role": "避难所铁壁", "tier": "R", "tier_color": "#3b82f6", "rarity": "Top 13.8%", "base_hash": 8200, "desc": "最坚韧的底层肉盾，通过极致的损管控制支撑起整个军团的存活。", "tags": ["极限损管", "绝对防线", "不死肉盾"], "skills": ["【被动】极限装甲并发", "【法术】毫米级断肢重生", "【护盾】最后叹息之墙"], "base_roi": 1.10, "volatility": 0.08, "market_style": "极低回撤避险与无风险倒把策略", "evolution_path": ["L1 营地卫士", "L2 堡垒主管"], "ultimate_evolution": "【永动核心】维持军团生命线的最终坚盾"},
    "ESFJ": {"role": "八面玲珑掮客", "tier": "SR", "tier_color": "#a855f7", "rarity": "Top 12.3%", "base_hash": 8750, "desc": "超级连接器，游走在各大财团与反抗军之间，是阵地战的最强润滑剂。", "tags": ["协作掮客", "情报控制", "社会缓冲"], "skills": ["【被动】政企超级链接", "【光环】社会化缓冲护盾", "【法术】多方仇恨均衡"], "base_roi": 1.20, "volatility": 0.15, "market_style": "庞大资金盘吸血与引导基金空手套白狼", "evolution_path": ["L1 见习掮客", "L2 黑市巨头"], "ultimate_evolution": "【政企超导桥梁】构筑不可替代的情报网护城河"},
    "ISTP": {"role": "暗夜拔线刺客", "tier": "SR", "tier_color": "#a855f7", "rarity": "Top 5.4%", "base_hash": 8950, "desc": "只对杀戮逻辑负责的幽灵，面对崩溃拔线即是真理。", "tags": ["物理切断", "硬核排爆", "极客杀手"], "skills": ["【被动】致命物理拔线", "【法术】量子黑盒引爆", "【光环】超体极客杀意"], "base_roi": 1.35, "volatility": 0.35, "market_style": "黑天鹅事件狙击、困境反转与暴力破解", "evolution_path": ["L1 独狼猎兵", "L2 灾备指挥官"], "ultimate_evolution": "【代码幽灵】掌控国家机房的物理生命力"},
    "ISFP": {"role": "幻象编织者", "tier": "R", "tier_color": "#3b82f6", "rarity": "Top 8.8%", "base_hash": 8150, "desc": "在血腥战争中，用致幻的美学神经毒素瓦解敌人的战意。", "tags": ["视觉致幻", "感官剥夺", "体验巅峰"], "skills": ["【被动】沉浸感官叙事", "【法术】低维美学抹杀", "【光环】心流深渊捕获"], "base_roi": 1.18, "volatility": 0.22, "market_style": "高奢非标资产与情绪致幻投资估值", "evolution_path": ["L1 幻觉特工", "L2 视觉暴君"], "ultimate_evolution": "【感官具象师】以一己之力拉升百倍幻象溢价"},
    "ESTP": {"role": "嗜血狂徒", "tier": "SSR", "tier_color": "#ffd700", "rarity": "Top 4.3%", "base_hash": 8800, "desc": "战线最前沿的敏锐猎手，能在枪林弹雨中嗅到暴利的机会。", "tags": ["野性直觉", "极速割喉", "实战暴徒"], "skills": ["【被动】毫秒瞬时割喉", "【战技】全图火力覆盖", "【光环】血腥红利嗅探"], "base_roi": 1.50, "volatility": 0.50, "market_style": "超高频日内白刃战与极限突发利好嗜血收割", "evolution_path": ["L1 突击兵", "L2 战地狼王"], "ultimate_evolution": "【极速套利猎手】全网废土套利空间的绝杀狙击者"},
    "ESFP": {"role": "末日偶像", "tier": "SR", "tier_color": "#a855f7", "rarity": "Top 9.9%", "base_hash": 8300, "desc": "各大阵营争夺的前台形象窗口，一言一行足以左右全网军心。", "tags": ["全域魅惑", "舆情控制", "精神广播"], "skills": ["【被动】全域舆论脑控", "【光环】情绪频率劫持", "【奥义】暴走危机降维"], "base_roi": 1.35, "volatility": 0.38, "market_style": "狂热粉丝驱动、社交网络暴动与情绪面收割", "evolution_path": ["L1 战地记者", "L2 精神领袖"], "ultimate_evolution": "【极速情绪信标】左右资本市场波动的首席发声端"}
}
...
CYBER_AUGMENTS = [
    {"id": "aug_spine", "name": "【反内卷神经切断器】", "cost": 10000, "cp_mult": 1.15, "san_cost": 20, "desc": "物理改造：全战力 +15% / 扣除20理智上限"},
    {"id": "aug_heart", "name": "【聚变抗压心脏】", "cost": 30000, "cp_mult": 1.30, "san_cost": 40, "desc": "物理改造：全战力 +30% / 扣除40理智上限"},
    {"id": "aug_eye",   "name": "【高维全视机械眼】", "cost": 80000, "cp_mult": 1.50, "san_cost": 70, "desc": "物理改造：全战力 +50% / 扣除70理智上限"}
]

# ==============================================================================
# 🎮 [ SECTION 3 ] 状态初始化与绝对安全的回调函数 (置顶以免疫 NameError)
# ==============================================================================
def init_state():
    defaults = {
        ...
        'weather': "🌑 废土死寂 (无特殊效果)",
        'world_chat': ["<span style='color:#f43f5e;'>[SYS] 终焉引擎 V50.0 已激活。齿轮开始转动。</span>"],
...
def set_toast(msg, icon="✅"):
    st.session_state.toast_msg = (msg, icon)

def cb_start_assessment():
...
def unlock_achievement(title):
    if title not in st.session_state.achievements:
        ...
        set_toast("🏆 解锁绝境成就：" + title + "！奖励 100 暗物质！", "🏆")
...
def gain_exp(amount):
    ...
    if st.session_state.exp >= req:
        ...
        set_toast("🌟 阶级跃迁！当前等级 Lv." + str(st.session_state.level), "🌟")
...
def tick_turn(*args, **kwargs):
    ...
    if random.random() < 0.18:
        weathers = ["⛈️ 量子风暴 (+30%量子战力)", "🔥 焦土裁员 (+30%炎脉战力)", "✨ 幽灵协议 (+30%灵能战力)", "🛡️ 绝对堡垒 (+30%钢核战力)", "💀 死亡加班 (获取经验翻倍)", "🏦 降息浪潮 (质押利息归零)", "🌑 废土死寂 (无特殊效果)"]
...
def cb_equip_title():
    tick_turn()
    st.session_state.equipped_title = st.session_state.get('title_sel_widget', st.session_state.equipped_title)
    set_toast("✅ 已佩戴：" + st.session_state.equipped_title, "✅")
...
def cb_dismantle(uid):
    ...
    for i, r in enumerate(st.session_state.inventory):
        if r['uid'] == uid:
            ...
            set_toast("♻️ 熔解成功！获得了 " + str(val) + " SDE。", "♻️")
            break
...
def cb_forge(consume_rarity, target_rarity):
    ...
    if len(avail) >= 3:
        ...
        if pool:
            ...
            if target_rarity == "UR": st.session_state.trigger_snow = True
    else: st.session_state.forge_msg = "❌ 材料不足：需要 3 件未装备的 " + consume_rarity + " 级材料！"

def cb_dispatch():
    stam_cost = 20
    if st.session_state.equipped_pet and "机械哈士奇" in st.session_state.equipped_pet.get('name',''): stam_cost = 10
    ok, msg = consume_action_points(stam_cost, 5)
    if not ok:
    ...
    if ev[1] == "token":
        ...
        if st.session_state.equipped_pet and "寻宝狐" in st.session_state.equipped_pet.get('name',''): amt = int(amt * 1.5)
...
def cb_boss_attack():
    if st.session_state.despair_level >= 100:
        ...
        return
    stam_cost = 15
    if st.session_state.equipped_pet and "机械哈士奇" in st.session_state.equipped_pet.get('name',''): stam_cost = 7
    ok, msg = consume_action_points(stam_cost, 10)
    if not ok:
    ...
    res_c = st.session_state.total_scores
    mbti_c = ("E" if res_c.get("E", 0) >= 0 else "I") + ("S" if res_c.get("S", 0) >= 0 else "N") + ("T" if res_c.get("T", 0) >= 0 else "F") + ("J" if res_c.get("J", 0) >= 0 else "P")
    faction_data_c = get_faction_info(mbti_c)
    player_element = faction_data_c['element']
    ...
    base_dmg = int(cp * random.uniform(0.8, 1.2) * mults['boss_dmg_mult'] * 0.15) 
    ...
    if mults['boss_dmg_mult'] > 1.0: dmg_tag += " [输出强化]"
    ...
    gain_exp(60)
    if "死亡加班" in st.session_state.weather: gain_exp(60)
    if st.session_state.boss_hp <= 0:
        st.session_state.combat_logs.insert(0, "🏆 Lv." + str(st.session_state.boss_level) + " 资本利维坦被击破！")
        ...
        st.session_state.dark_matter += 150 * st.session_state.boss_level
        st.session_state.boss_level += 1
        st.session_state.boss_hp = 2000000 * st.session_state.boss_level

def cb_pvp_battle():
    target_faction = st.session_state.get("pvp_target_widget", "无名阵营")
    if st.session_state.despair_level >= 100:
        st.session_state.pvp_logs.insert(0, "💀 基因崩溃，你已经疯了。无法战斗。")
        return
    stam_cost = 15
    if st.session_state.equipped_pet and "机械哈士奇" in st.session_state.equipped_pet.get('name',''): stam_cost = 7
    ok, msg = consume_action_points(stam_cost, 10)
    ...
    st.session_state.pvp_logs.insert(0, "⚔️ 突袭阵营: " + target_faction + " (敌战力: {:,})".format(enemy_cp))
    if cp >= enemy_cp:
        ...
        st.session_state.dark_matter += random.randint(2, 8)
        gain_exp(70)
    else:
        loss = int(cp * random.uniform(0.01, 0.05))
        if st.session_state.equipped_pet and "机械哈士奇" in st.session_state.equipped_pet.get('name',''):
            loss = int(loss * 0.5)
            st.session_state.pvp_logs.insert(0, "🐾 [猎犬] 护主，抵挡了 50% 资源损失！")
        ...
        st.session_state.despair_level = min(100, st.session_state.despair_level + 15)
        gain_exp(15)
...
def cb_talent_up(dim):
    ...
    if st.session_state.tokens >= cost_sde and st.session_state.logic_shards >= cost_shards:
        ...
        set_toast("🧬 " + dim + " 属性飞升！生态乘区强化！", "🧬")
    else: set_toast("❌ SDE 或逻辑碎片不足！(碎片需远征获得)", "❌")
...
def cb_upgrade_foil():
    ...
    if idx < 3:
        if st.session_state.dark_matter >= costs[idx+1]:
            ...
            set_toast("✨ 卡面工艺升级成功！战力乘区扩大！", "✨")
            st.session_state.trigger_balloons = True
            if idx+1 == 3: unlock_achievement("【创世之影】")
        else: set_toast("❌ 暗物质不足！", "❌")
    else: set_toast("已达到最高工艺！", "✅")
...
def cb_exchange_buy():
    ...
    if st.session_state.tokens >= cost:
        ...
        set_toast("✅ 成功买入 10 暗物质", "✅")
    else: set_toast("❌ SDE 不足", "❌")
...
def cb_exchange_sell():
    ...
    if st.session_state.dark_matter >= 10:
        ...
        set_toast("✅ 成功卖出 10 暗物质", "✅")
    else: set_toast("❌ 暗物质不足", "❌")

def cb_join_faction():
    tick_turn()
    st.session_state.joined_faction = st.session_state.get('faction_sel_widget', '硅基抵抗军 (量子)')
    set_toast("🛡️ 成功宣誓效忠！", "🛡️")
...
def cb_draw_tarot():
    ...
    if st.session_state.tokens >= 200:
        ...
        set_toast("🃏 塔罗指引：" + st.session_state.tarot_buff, "🃏")
    else: set_toast("❌ 资金不足！", "❌")
...
def cb_ascend_card():
    ...
    if st.session_state.dark_matter >= cost and st.session_state.ascension_stars < 5:
        ...
        if st.session_state.ascension_stars == 5:
            st.session_state.ascended = True; unlock_achievement("【超维神明】"); st.session_state.trigger_balloons = True
    else: set_toast("❌ 暗物质不足！", "❌")
...
def cb_altar_blood():
    ...
    if st.session_state.sanity > 30:
        ...
        set_toast("🩸 祭祀成功！获得 " + str(gain) + " 暗物质！污染加深...", "🩸")
        add_chat(st.session_state.user_alias + " 进行了禁忌的鲜血祭祀...", "#ff003c")
    else: set_toast("❌ 理智太低，祭祀会死的！", "❌")
...
def cb_casino():
    ...
    if st.session_state.tokens >= 1000:
        ...
        if random.random() < 0.3:
            st.session_state.tokens += 3500; set_toast("🎰 狂热大奖！赢得 3500 SDE！", "🤑")
...
def cb_confirm_squad():
    tick_turn()
    st.session_state.squad = [st.session_state.get('squad_p1'), st.session_state.get('squad_p2')]
    set_toast("🤝 战术小队编成确认！", "✅")
...
# ==============================================================================
# 🖥️ [ UI 07 ] 塔台级路由与全息渲染 (内联布局消除 NameError)
# ==============================================================================
safe_html(CSS_BLOCK)
...
if not st.session_state.started:
    ...
    with c_l2:
        ...
        with st.form(key="login_form", border=False):
            ...
            safe_html("<br>")
            st.form_submit_button("▶ 开启神经元接驳并呼叫空投", on_click=cb_start_assessment, type="primary", use_container_width=True)

elif st.session_state.calculating:
    _, c_c2, _ = st.columns([1, 2, 1])
    with c_c2:
    ...
    with c_q2:
        ...
        for text, val in opts: 
            st.button(text, key="q_" + str(st.session_state.current_q) + "_" + str(val), on_click=cb_answer_q, args=(val, q_data['dim']), use_container_width=True)
    ...
    data = MBTI_DICT.get(mbti, MBTI_DICT["INTJ"])
    ...
    if "asset_minted" not in st.session_state or st.session_state.asset_minted.get("version") != VERSION:
        ...
        st.session_state.asset_minted = {
            ...
            "mbti": mbti,
            "block_height": "V50-" + str((int(time.time()) % 1000000)).zfill(6),
    ...
    # =========================================================================
    with st.sidebar:
        safe_html("<div style='text-align:center; font-family:Orbitron; font-size:20px; font-weight:900; color:#00f3ff; margin-bottom:20px;'>ECO HUD V50</div>")
        ...
        st.selectbox("佩戴军衔:", st.session_state.titles_owned, index=idx, key="title_sel_widget", label_visibility="collapsed", on_change=cb_equip_title)
        ...
        if st.session_state.staked_tokens > 0:
            ...
            st.button("📤 提取洗白资金", on_click=cb_claim_yield, use_container_width=True)
    ...
    with t_combat:
        ...
        with c_tc2:
            ...
            st.selectbox("🎯 锁定敌对派系:", ["硅基抵抗军", "幽能清道夫", "秩序裁决所", "混沌暴徒"], key="pvp_target_widget", label_visibility="collapsed")
    ...
    with t_econ:
        ...
        with c_te1:
            ...
            with c_st2:
                ...
                st.button("📤 提取全部利息", on_click=cb_claim_yield, type="primary", use_container_width=True)
        with c_te2:
    ...
    with t_syn:
        ...
        options_list = list(MBTI_DICT.keys())
        format_func = lambda x: f"{x} - {MBTI_DICT[x]['role']}"
        col_s1, col_s2, col_s3 = st.columns([2, 2, 1])
        
        idx1 = options_list.index(st.session_state.squad[0]) if st.session_state.squad[0] in options_list else options_list.index("ESTJ")
        idx2 = options_list.index(st.session_state.squad[1]) if st.session_state.squad[1] in options_list else options_list.index("INTJ")
        
        with col_s1: st.selectbox("🎯 战术小队成员 1:", options=options_list, index=idx1, format_func=format_func, key="squad_p1", label_visibility="collapsed")
        with col_s2: st.selectbox("🎯 战术小队成员 2:", options=options_list, index=idx2, format_func=format_func, key="squad_p2", label_visibility="collapsed")
        with col_s3: st.button("✅ 确认编队", on_click=cb_confirm_squad, use_container_width=True)
        
        curr_m1 = st.session_state.squad[0] if st.session_state.squad[0] in options_list else st.session_state.get('squad_p1', 'ESTJ')
        curr_m2 = st.session_state.squad[1] if st.session_state.squad[1] in options_list else st.session_state.get('squad_p2', 'INTJ')
    ...
    with t_data:
        ...
        with c_td1:
            ...
            if not st.session_state.joined_faction:
                st.selectbox("宣誓效忠的阵营 (若匹配核心将获10%战力增幅):", ["硅基抵抗军 (量子)", "幽能清道夫 (灵能)", "秩序裁决所 (钢核)", "混沌暴徒 (炎脉)"], key="faction_sel_widget")
    ...
    with t_oracle:
        ...
        HTML_ORACLE = ORACLE_CSS.replace('\n', '') + "<div class=\"oracle-box\"><div class=\"oracle-hdr\">[AI_ORACLE_V50] SURVIVAL DIAGNOSTIC...</div><span class=\"oracle-line\">> Extracting Node [ " + safe_alias_final + " ] Weights... [OK]</span><span class=\"oracle-line\">> Bypassing Meatspace Firewall... [SUCCESS]</span><span class=\"oracle-line\">> Decrypting Matrix... [OK]</span><span class=\"oracle-line\">> Node Classified As: <span style=\"color:#ffd700; font-weight:bold;\">" + mbti + "</span></span><span class=\"oracle-line-fade\">> ULTIMATE EVOLUTION PREDICTION: <br><span style=\"color:#ff003c; font-size:14px; font-weight:bold;\">" + data.get('ultimate_evolution', '') + "</span></span></div>"
    ...
    with t_mint:
        ...
        with tm1:
            ...
            pet_text = st.session_state.equipped_pet.get('name', '') if st.session_state.equipped_pet else "无伴生兽"
            ...
            HTML_POSTER_BODY = (
                ...
                '<div style="margin-bottom:2px;font-weight:bold;">SDE WARFRAME TCG V50.0</div><div style="color:#475569;">© ' + COPYRIGHT + ' | ID: #' + str(token_id) + '</div></div></div>'
        ...
        with tm2:
            ...
            share_card = "【SDE 职场元宇宙：终焉矩阵 V50】\n=================================\n👤 幸存者代号：" + safe_alias_final + "\n🎖️ 史诗军衔：" + st.session_state.equipped_title + "\n💎 战力估值：" + "{:,}".format(final_cp) + " CP (Lv." + str(st.session_state.level) + ")\n🧬 核心架构：" + mbti + " (" + role_name + ")\n🛡️ 所属阵营：" + faction_str_txt + "\n👑 生存段位：" + rank_name + "\n⚡️ 存活率击败：全球 TOP " + "{:.1f}".format(100 - pct_beat_final) + "%\n⚔️ 专属武装：" + relics_str_txt + "\n🐾 伴生机甲：" + pet_str_txt + "\n🎴 卡面工艺：" + card_foil + "\n🚀 终极演进：" + data.get('ultimate_evolution', '') + "\n=================================\n🌐 2026 齿轮转动，万物同调。\n🔗 [Token ID: #" + str(token_id) + " | Hash: 0x" + hash_code[:8] + "]"
